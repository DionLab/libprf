...
if(GD_LIBRARY AND GD_INCLUDE_DIRS)
  set(GD_LIBRARIES ${GD_LIBRARY})
  set(GD_FOUND "YES")
else(GD_LIBRARY AND GD_INCLUDE_DIRS)
  set(GD_FOUND "NO")
endif(GD_LIBRARY AND GD_INCLUDE_DIRS)
  ...
  if(WIN32 AND NOT CYGWIN)
    ...
    if(GD_SUPPORTS_PNG)
      ...
      if(PNG_FOUND)
        ...
        set(GD_INCLUDE_DIRS ${GD_INCLUDE_DIRS} ${PNG_INCLUDE_DIRS})
      else(PNG_FOUND)
